  ...
  $.fn.customA11ySelect = function(params) {
    ...
    return this.each(function() {
      ...
      function buildMenu(selectMenu) {
        ...
        var button = $('<button type="button" id="'+menuID+'-button" class="custom-a11yselect-btn" aria-expanded="false" aria-haspopup="true"><span class="custom-a11yselect-text" id="'+menuID+'-selected"></span><i class="custom-a11yselect-icon fa fa-angle-down"></i></button>');
    ...
    function toggleDropdown($button) {
      ...
      $icon.toggleClass('fa fa-angle-down').toggleClass('fa fa-angle-up');
